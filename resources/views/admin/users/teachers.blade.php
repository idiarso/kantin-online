...
@section('header')
    <div class="flex justify-between items-center">
        <h2 class="text-2xl font-semibold text-gray-800">Teachers Management</h2>
        <a href="{{ route('admin.users.create', ['role' => 'teacher']) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="p-6">
            <div class="flex justify-between items-center mb-4">
                <div class="flex-1">
                    <input type="text" id="search" placeholder="Search teachers..."

...
@section('header')
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.users.create', ['role' => 'student']) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex items-center space-x-4">
                    <select id="class-filter" class="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        @foreach(['X-A', 'X-B', 'XI-A', 'XI-B', 'XII-A', 'XII-B'] as $class)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function filterRows() {
        ...
        Array.from(rows).forEach(row => {
            ...
            row.classList.toggle('hidden', !matchesSearch || !matchesStatus || !matchesClass);
        });
    }
